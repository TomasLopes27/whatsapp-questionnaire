import os, requests, json, questions_mock, settings, logging
...
def send_interactive_message(phone_number, question, buttons):
    ...
    data = {
        ...
        "interactive": {
            ...
            "body": {"text": question},
            "action": {
                "buttons": [{"type": "reply", "reply": button} for button in buttons]
            },
        },
    }
...
def handle_questionnaire(phone_number, text):
    ...
    if next_question_index < len(questions):
        ...
        write_response_to_file(
            phone_number, next_question_index, current_question, text
        )
